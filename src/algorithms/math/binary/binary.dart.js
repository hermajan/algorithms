...
["", "binary.dart", , Z, {
  "^": "",
  main: [function() {
    var t1 = J.get$onInput$x(document.querySelector("#num"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(Z.binaryEvent$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  binaryEvent: [function(e) {
    var num, exception;
    num = H.interceptedTypeCast(J.get$target$x(e), "$isInputElement").value;
    try {
      document.querySelector("#binDart").textContent = J.toRadixString$1$n(H.Primitives_parseInt(num, null, null), 2);
    } catch (exception) {
  ...
  }, "call$1", "binaryEvent$closure", 2, 0, 2]
},
1],
